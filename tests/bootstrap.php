...
if (!$dbExists) {
    array_push(
        ...
        // drop doctrine_migration_versions table too
        'bin/console doctrine:query:sql --env=test "DROP TABLE IF EXISTS doctrine_migration_versions"',
        // re-create empty doctrine_migration_versions table
